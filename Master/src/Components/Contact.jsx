            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="rounded-3xl border border-sky-100 bg-gradient-to-br from-sky-50 via-teal-50 to-white p-6 shadow-sm space-y-3">
                ...
                <div className="pt-2 border-t border-sky-100 flex flex-wrap items-center justify-between gap-3 text-xs">
                  ...
                  <div className="flex items-center gap-3">
                    <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 font-semibold text-slate-700 hover:text-slate-900 transition-colors" title="GitHub Profile">
                    ...
                    <a href="#" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1 font-semibold text-sky-600 hover:text-sky-700 transition-colors" title="LinkedIn Profile">
