...
-- Compatible with MySQL 5.7+, MySQL 8.0+, MariaDB, Railway MySQL
-- Run this on Railway MySQL via: mysql -h HOST -u USER -p dental < dental.sql
...
-- --------------------------------------------------------
-- Seed Data (plain-text passwords — login works for demo)
-- --------------------------------------------------------
INSERT IGNORE INTO user (id, FirstName, Email, Password, Gender, Address, Number, Specialist, Position, licencenumber, Image, status, admin) VALUES
...
INSERT IGNORE INTO appointment (id, user_id, Name, date, time, Email, DoctorId, token, payment_status, razorpay_payment_id, description, CustomerNumber) VALUES
